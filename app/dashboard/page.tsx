...
const Dashboard = () => {
	...
	return (
		<div className='min-h-screen max-h-screen min-w-screen bg-[#003873] lg:p-12 flex flex-row gap-4'>
			{/* Side bar
			...
			<div className='bg-white w-full max-h-screen p-2 lg:p-4 rounded-lg shadow-lg shadow-black'>
				...
				<div className='w-full p-4'>
					<div className='flex flex-col gap-4 h-full max-h-[75vh] overflow-auto'>
						...
						<div className='border-2 border-[#F47940]/90 rounded-md h-full overflow-auto'>
							{clients.map((client) => (
								<div
									className={`${
